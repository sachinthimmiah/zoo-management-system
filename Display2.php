...
if($result)
{
    while ($row = mysqli_fetch_assoc($result)) 
    {
      ...
      <button class="btn btn-primary"><a href="View.php? viewid='.$TicketID.'" class="text-light">View</a></button>
      <button class="btn btn-danger"><a href="delete1.php? deleteid='.$TicketID.'" class="text-light">Delete</a></button>
