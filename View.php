                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body" id="exampl">
                                        <?php
 $vid=$_GET['viewid'];
$ret=mysqli_query($con,"select * from tcktnormal where ID='$vid' || TicketID='$vid'");
$cnt=1;
while ($row=mysqli_fetch_array($ret)) {

?>
                                        <h3 class="header-title" style="color: blue">Ticket ID: <?php  echo $row['TicketID'];?></h3>
                                        <h3 class="header-title" style="color: blue">Visiting Date: <?php  echo $row['PostingDate'];?></h3>
                                          <h3 class="header-title" style="color: blue">Visitor Name: <?php  echo $row['VisitorName'];?></h3>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 10px"><?php  echo $noadult=$row['NoAdult'];?></td>
                                     <td style="padding-left: 10px">$<?php  echo $cup=$row['Adultprice'];?></td>
                                ...
                                <tr>
                                    ...
                                    <td style="padding-left: 10px">$<?php  echo $aup=$row['Childrenprice'];?></td>
